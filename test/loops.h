 ...
 public:
  ...
  Indices operator*() const {
    ...
    switch (counter) {
        // 1D Tensor<elt_t>
      case 1:
        P = Tensor<double>::empty(d(0) * d(1) * d(2) * d(3));
        break;
        // 2D Tensor<elt_t>
      case 2:
        P = Tensor<double>::empty(d(0), d(1) * d(2) * d(3));
      ...
      case 4:
        ...
        break;
      case 5:
        P = Tensor<double>::empty(d(3), d(0) * d(1) * d(2));
        break;
      case 6:
        P = Tensor<double>::empty(d(2) * d(3), d(0) * d(1));
        break;
        // 3D Tensor<elt_t>
      case 7:
        P = Tensor<double>::empty(d(0), d(1), d(2) * d(3));
      ...
      case 8:
        ...
        break;
      case 9:
        P = Tensor<double>::empty(d(3) * d(2), d(0), d(1));
        break;
        // 4D Tensor<elt_t>
      case 10:
        P = Tensor<double>::empty(d(0), d(1), d(2), d(3));
        break;
      case 11:
        P = Tensor<double>::empty(d(3), d(1), d(2), d(0));
        break;
      case 12:
        P = Tensor<double>::empty(d(1), d(0), d(3), d(2));
        break;
      case 13:
        P = Tensor<double>::empty(d(2), d(0), d(3), d(1));
        break;
    }
    return P.dimensions();
  }
