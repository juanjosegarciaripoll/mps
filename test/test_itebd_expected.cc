...
const iTEBD<Tensor> random_product(int d, bool same = false, Tensor *pA = 0,
                                   Tensor *pB = 0) {
...
TEST(RiTEBDTest, AKLTStringOrder1) { test_aklt_string_order<RTensor>(1); }

TEST(RiTEBDTest, AKLTStringOrder2) { test_aklt_string_order<RTensor>(2); }

TEST(RiTEBDTest, AKLTStringOrder4) { test_aklt_string_order<RTensor>(4); }

TEST(RiTEBDTest, AKLTStringOrder8) { test_aklt_string_order<RTensor>(8); }

TEST(RiTEBDTest, AKLTStringOrder16) { test_aklt_string_order<RTensor>(16); }
...
TEST(CiTEBDTest, AKLTStringOrder1) { test_aklt_string_order<CTensor>(1); }

TEST(CiTEBDTest, AKLTStringOrder2) { test_aklt_string_order<CTensor>(2); }

TEST(CiTEBDTest, AKLTStringOrder4) { test_aklt_string_order<CTensor>(4); }

TEST(CiTEBDTest, AKLTStringOrder8) { test_aklt_string_order<CTensor>(8); }

TEST(CiTEBDTest, AKLTStringOrder16) { test_aklt_string_order<CTensor>(16); }
