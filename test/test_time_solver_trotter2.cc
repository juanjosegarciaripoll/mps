...
namespace tensor_test {
  ...
  TEST(Trotter2Solver, LocalOperatorSzFull) {
    test_over_integers(2, 5, evolve_local_operator_sz, test_Trotter2_no_truncation);
  }

  TEST(Trotter2Solver, LocalOperatorSzTruncated) {
    test_over_integers(2, 5, evolve_local_operator_sz, test_Trotter2_truncated<2>);
  }

  TEST(Trotter2Solver, LocalOperatorSxFull) {
    test_over_integers(2, 5, evolve_local_operator_sx, test_Trotter2_no_truncation);
  }

  TEST(Trotter2Solver, LocalOperatorSxTruncated) {
    test_over_integers(2, 5, evolve_local_operator_sx, test_Trotter2_truncated<2>);
  }
